...
const EN: UiStrings = {
  ...
  selectProfilePrompt: "Select a profile on the left to see and edit its EQ.",
...
const JA: UiStrings = {
  ...
  selectProfilePrompt: "左のリストからプロファイルを選ぶとEQを編集できます。",
...
const DE: UiStrings = {
  ...
  selectProfilePrompt: "Wähle links ein Profil aus, um dessen EQ zu bearbeiten.",
...
const FR: UiStrings = {
  ...
  selectProfilePrompt: "Sélectionnez un profil à gauche pour modifier son EQ.",
...
const ES: UiStrings = {
  ...
  selectProfilePrompt: "Selecciona un perfil a la izquierda para editar su EQ.",
...
const NL: UiStrings = {
  ...
  selectProfilePrompt: "Kies links een profiel om de EQ ervan te bewerken.",
